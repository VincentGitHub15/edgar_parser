...
cik = str(cik)
url = "http://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK={cik_arg}&type=13F-HR&dateb=&owner=exclude&count=40&output=atom".format(cik_arg=cik)
# print(url)
# print(url.read())

with urllib.request.urlopen(url) as response:
	results_page = response.read()
	print(results_page, "help")
